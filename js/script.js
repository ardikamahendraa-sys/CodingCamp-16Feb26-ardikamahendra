    ...
    row.innerHTML = `
      ...
      <td>
        <div class="flex gap-1">
          ...
          <button class="btn btn-success btn-xs toggle-btn text-white" data-id="${
            todo.id
          }" title="${todo.completed ? "Mark Incomplete" : "Mark Complete"}">
            <i class="bx ${todo.completed ? "bx-x" : "bx-check"} text-white"></i>
          </button>
          <button class="btn btn-error btn-xs delete-btn text-white" data-id="${
            todo.id
          }" title="Delete">
